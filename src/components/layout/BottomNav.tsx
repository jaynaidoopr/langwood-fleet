...
import {
  Map, Truck, Route as RouteIcon, Bell,
} from 'lucide-react';
...
/** Decluttered core set for the Android app: Map, Devices, Trips, Alerts only. */
const NAV_ITEMS: NavItem[] = [
  { path: '/tracking', key: 'monitor', icon: Map },
  { path: '/devices', key: 'devices', icon: Truck },
  { path: '/reports/trips', key: 'trips', icon: RouteIcon },
...
const BottomNav = memo(function BottomNav() {
  ...
  const isActive = (path: string) => {
    if (path === '/reports/trips') {
      return basePath === '/reports' || basePath === '/trips';
    }
    if (path === '/tracking') {
